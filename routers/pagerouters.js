...
const { intro_get, about_get, addproject_get, contact_get, login_get, portfolio_get, login_post, addproject_post, get_projects2, get_deleteproject, post_deleteprojects, contact_post, get_messages }=require("../controllers/pageController")
const { requireAuth, get_projects1, get_messages2 } = require("../middleware/middleware")
